...
#include "GUI_ModsMenu.h"
#include "GUIManager.h"
#include "GUIUtils.h"

void RoR::GUI::ModsMenu::Draw()
{
    ...
    if (ImGui::Button("General"))    { m_tab = ModsTab::GENERAL; }
    ImGui::SameLine();
    if (ImGui::Button("Controls"))   { m_tab = ModsTab::CONTROL; }
    ImGui::SameLine();
    if (ImGui::Button("Video"))      { m_tab = ModsTab::VIDEO;   }
    ImGui::SameLine();
    if (ImGui::Button("Diagnostic")) { m_tab = ModsTab::DIAG;    }
